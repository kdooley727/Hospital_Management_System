...
namespace Hospital_Management_System._5._1_Data_Analytics
{
	...
	public partial class DataAnalyticsDataContext : System.Data.Linq.DataContext
	{
    ...
    partial void InsertMedicationsAndSupply(MedicationsAndSupply instance);
    partial void UpdateMedicationsAndSupply(MedicationsAndSupply instance);
    partial void DeleteMedicationsAndSupply(MedicationsAndSupply instance);
    partial void InsertMedicationsUsage(MedicationsUsage instance);
    partial void UpdateMedicationsUsage(MedicationsUsage instance);
    partial void DeleteMedicationsUsage(MedicationsUsage instance);
    #endregion
		
		public DataAnalyticsDataContext() : 
				base(global::Hospital_Management_System.Properties.Settings.Default.HMSCOREConnectionString1, mappingSource)
		{
			OnCreated();
		}
		
		public DataAnalyticsDataContext(string connection) : 
				base(connection, mappingSource)
		{
			OnCreated();
		}
		
		public DataAnalyticsDataContext(System.Data.IDbConnection connection) : 
				base(connection, mappingSource)
		{
			OnCreated();
		}
		
		public DataAnalyticsDataContext(string connection, System.Data.Linq.Mapping.MappingSource mappingSource) : 
				base(connection, mappingSource)
		{
			OnCreated();
		}
		
		public DataAnalyticsDataContext(System.Data.IDbConnection connection, System.Data.Linq.Mapping.MappingSource mappingSource) : 
				base(connection, mappingSource)
		{
			OnCreated();
		}
		...
		public System.Data.Linq.Table<MedicationsAndSupply> MedicationsAndSupplies
		{
			get
			{
				return this.GetTable<MedicationsAndSupply>();
			}
		}
		
		public System.Data.Linq.Table<MedicationsUsage> MedicationsUsages
		{
			get
			{
				return this.GetTable<MedicationsUsage>();
			}
		}
	}
	...
	public partial class PatientTableNew : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private EntitySet<MedicationsUsage> _MedicationsUsages;
    ...
    partial void OnPatient_InsuranceChanged();
		...
		public PatientTableNew()
		{
			...
			this._MedicationsUsages = new EntitySet<MedicationsUsage>(new Action<MedicationsUsage>(this.attach_MedicationsUsages), new Action<MedicationsUsage>(this.detach_MedicationsUsages));
			OnCreated();
		}
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="PatientTableNew_MedicationsUsage", Storage="_MedicationsUsages", ThisKey="PatientID", OtherKey="PatientID")]
		public EntitySet<MedicationsUsage> MedicationsUsages
		{
			get
			{
				return this._MedicationsUsages;
			}
			set
			{
				this._MedicationsUsages.Assign(value);
			}
		}
		...
		private void attach_MedicationsUsages(MedicationsUsage entity)
		{
			this.SendPropertyChanging();
			entity.PatientTableNew = this;
		}
		
		private void detach_MedicationsUsages(MedicationsUsage entity)
		{
			this.SendPropertyChanging();
			entity.PatientTableNew = null;
		}
	...
	[global::System.Data.Linq.Mapping.TableAttribute(Name="dbo.MedicationsAndSupplies")]
	public partial class MedicationsAndSupply : INotifyPropertyChanging, INotifyPropertyChanged
	{
    ...
    partial void OnUnitPriceChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="MedicationsAndSupply_MedicationsUsage", Storage="_MedicationsUsages", ThisKey="ID", OtherKey="MedicationID")]
		public EntitySet<MedicationsUsage> MedicationsUsages
		{
			get
			{
		...
		{
			this.SendPropertyChanging();
			entity.MedicationsAndSupply = this;
		}
		
		private void detach_MedicationsUsages(MedicationsUsage entity)
		{
			this.SendPropertyChanging();
			entity.MedicationsAndSupply = null;
		}
	}
	
	[global::System.Data.Linq.Mapping.TableAttribute(Name="dbo.MedicationsUsage")]
	public partial class MedicationsUsage : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private EntityRef<MedicationsAndSupply> _MedicationsAndSupply;
    ...
    partial void OnNotesChanged();
		...
		public MedicationsUsage()
		{
			this._MedicationsAndSupply = default(EntityRef<MedicationsAndSupply>);
			this._PatientTableNew = default(EntityRef<PatientTableNew>);
			OnCreated();
		}
		...
		public int MedicationID
		{
			...
			set
			{
				...
				{
					if (this._MedicationsAndSupply.HasLoadedOrAssignedValue)
					{
						throw new System.Data.Linq.ForeignKeyReferenceAlreadyHasValueException();
					}
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="MedicationsAndSupply_MedicationsUsage", Storage="_MedicationsAndSupply", ThisKey="MedicationID", OtherKey="ID", IsForeignKey=true)]
		public MedicationsAndSupply MedicationsAndSupply
		{
			get
			{
				return this._MedicationsAndSupply.Entity;
			}
			set
			{
				MedicationsAndSupply previousValue = this._MedicationsAndSupply.Entity;
				if (((previousValue != value) 
							|| (this._MedicationsAndSupply.HasLoadedOrAssignedValue == false)))
				{
					this.SendPropertyChanging();
					if ((previousValue != null))
					{
						this._MedicationsAndSupply.Entity = null;
						previousValue.MedicationsUsages.Remove(this);
					}
					this._MedicationsAndSupply.Entity = value;
					if ((value != null))
					{
						value.MedicationsUsages.Add(this);
						this._MedicationID = value.ID;
					}
					else
					{
						this._MedicationID = default(int);
					}
					this.SendPropertyChanged("MedicationsAndSupply");
				}
			}
		}
		
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="PatientTableNew_MedicationsUsage", Storage="_PatientTableNew", ThisKey="PatientID", OtherKey="PatientID", IsForeignKey=true)]
		public PatientTableNew PatientTableNew
		{
			get
			{
